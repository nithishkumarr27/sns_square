  ...
  return (
    <div className="w-full bg-white min-h-screen">
      ...
      <div className="relative w-full h-screen min-h-[800px] bg-gradient-to-br from-[#6366F1] via-[#8b9cf7] to-[#a5b4fc] overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-40 flex flex-col items-center justify-center h-full px-4 sm:px-6 lg:px-8 pt-16">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            {/* Hero Title */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight font-sans">
              <span className="text-black">We partner with you in your </span>
              <span className="text-[#2563EB]">Agentic Solution</span>
              <span className="text-black"> Journey.</span>
            </h1>
           
            {/* Hero Description */}
            <p className="text-lg sm:text-xl lg:text-2xl font-normal text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
            ...
            <div className="pt-8">
              <Button
                variant="primary"
                size="large"
                className="rounded-full px-10 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                onClick={() => {}}
              >
      ...
      <div className="relative -mt-32 z-30 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Background Gradient */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#c8d8f8] to-[#fcfdfe] rounded-3xl transform rotate-1" />
         
          <div className="relative bg-white/50 backdrop-blur-sm rounded-3xl p-8 lg:p-16">
            {/* Feature Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className="bg-[#e6edfc] rounded-xl p-4 w-16 h-16 flex items-center justify-center mb-4">
                  <img src="/images/img_background.svg" alt="Outcome Optimization" className="w-8 h-8" />
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className="bg-[#e6edfc] rounded-xl p-4 w-16 h-16 flex items-center justify-center mb-4">
                  <img src="/images/img_68308cbe6815a2d.svg" alt="Domain Versatility" className="w-8 h-8" />
                </div>
                <h3 className="text-xl font-inter font-medium text-[#040404] mb-2">
                  Domain <br />Versatility
                </h3>
                <p className="text-sm font-manrope font-medium text-gray-600">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className="bg-[#e6edfc] rounded-xl p-4 w-16 h-16 flex items-center justify-center mb-4">
                  <img src="/images/img_68308cbee7a4011.svg" alt="AI Engineering Fast" className="w-8 h-8" />
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className="bg-[#e6edfc] rounded-xl p-4 w-16 h-16 flex items-center justify-center mb-4">
                  <img src="/images/img_search.svg" alt="Fast Agentic" className="w-8 h-8" />
                </div>
     ...
     {/* <Lock/> */}
      ...
      <div className="py-16 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-manrope font-bold text-black leading-tight">
            ...
            <div className="flex pl-8 justify-center">
              <img
                ...
                className="max-w-3xl h-auto object-cover rounded-2xl"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 lg:p-16 overflow-hidden">
            ...
            <div
              ...
              style={{ backgroundImage: "url('/images/img_lucidoriginaprofessional3dglassystyleillustrationsymbol0_1.png')" }}
            />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-sora font-semibold leading-tight">
              <span className="text-[#064ee3]">Not Just Tech. <br /></span>
              <span className="text-[#242424]">Agentic Solutions That Deliver.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              {/* Innovation at Core */}
              <div className="bg-[#e6edfc] rounded-2xl p-6 lg:p-8">
              ...
              {/* AI-Only Engineering */}
              <div className="bg-[#c5ede0] rounded-2xl p-6 lg:p-8">
                <h4 className="text-xl lg:text-2xl font-manrope font-bold text-[#040404] mb-4">
                  AI-Only Engineering
                </h4>
                <p className="text-sm lg:text-base font-inter text-[#242424]/70 leading-relaxed">
